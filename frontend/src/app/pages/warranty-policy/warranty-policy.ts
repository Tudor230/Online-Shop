  ...
  readonly coverageByCategory: readonly WarrantyCoverage[] = [
    {
      ...
      period: '24 months',
      details:
        'Covers assembly defects, power delivery faults, and component failures under normal use.',
    },
    {
      category: 'Monitors and displays',
      period: '24 months',
      details:
        'Covers panel, backlight, and controller defects. Pixel policy follows manufacturer thresholds.',
    },
    {
    ...
    },
    {
      ...
      details:
        'Battery wear from normal charge cycles is excluded unless performance drops below warranty specs.',
    },
  ];
