...
export class PrivacyPolicyPageComponent {
  ...
  readonly retentionRules: readonly RetentionRule[] = [
    { dataType: 'Order and invoice records', retention: 'Up to 10 years where tax/accounting law requires it' },
    { dataType: 'Account profile data', retention: 'Until account deletion request, plus a short backup window' },
    { dataType: 'Support and warranty requests', retention: 'Up to 3 years after issue closure for service continuity' },
    { dataType: 'Analytics cookie identifiers', retention: 'Typically 13 months or less, depending on tool settings' }
  ];
