...
public interface AdminAuditLogRepository extends JpaRepository<AdminAuditLog, UUID> {
    ...
    Page<AdminAuditLog> findByAdminUserId(UUID adminUserId, Pageable pageable);

    Page<AdminAuditLog> findByEntityTypeAndEntityId(String entityType, String entityId, Pageable pageable);

    Page<AdminAuditLog> findByActionType(String actionType, Pageable pageable);
