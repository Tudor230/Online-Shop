...
public class ProductService {
    ...
    public ProductSearchPageDto getProducts(String query, String sort, Pageable pageable) {
        Page<Product> page = productEmbeddingService.findActiveProducts(query, sort, pageable);
